...
install -m 0755 /tmp/yazi/yazi-x86_64-unknown-linux-gnu/yazi /usr/local/bin/yazi
install -m 0755 /tmp/yazi/yazi-x86_64-unknown-linux-gnu/ya /usr/local/bin/ya
